<template>
  <div> 
    ...
    style="background-image: url(/images/main_images/novosti.jpg); background-position-x: 50%; padding-top: 15%; padding-bottom: 15%; background-position-y: 50%;">
...
export default {
  ...
  async fetch(){
    this.items = await fetch(
      process.env.imagesBaseUrl + 'api/getNews'
