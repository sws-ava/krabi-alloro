<template>
  <div> 
    ...
    style="background-image: url(/images/main_images/aktsii.jpg); background-size:100%; background-position-x: 50%; padding-top: 15%; padding-bottom: 15%; background-position-y: 50%;">
