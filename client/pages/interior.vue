<template>
  <div> 
    ...
    style="background-image: url(/images/main_images/interer.jpg); background-position-x: 50%; padding-top: 15%; padding-bottom: 15%; background-position-y: 50%;">
...
export default {
  ...
  head(){
    return{
      title: this.$i18n.t('static.interiorTitle') + ' ::  ' + this.$i18n.t('static.siteName'),
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: this.$i18n.t('static.interiorTitle'),
        },
      ]
    }
  },
